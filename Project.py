...
def better_Value():
    ...
    if (c < c1):
        ...
        result_A_Label = Label(font=('Kanit',18),fg='#008000',text=value_result_A)
        result_A_Label.place(x=200,y=300)
        result_B_Label = Label(font=('Kanit',18),fg='#FF0000',text=value_result_B)
        result_B_Label.place(x=200,y=350)
        result_low_price = Label(font=('Kanit',18),text=low_price)
        ...
        result_A_Label = Label(font=('Kanit',18),text=value_result_A)
        result_A_Label.place(x=200,y=300)
        result_B_Label = Label(font=('Kanit',18),text=value_result_B)
        result_B_Label.place(x=200,y=350)
        result_low_price = Label(font=('Kanit',18),text=low_price)
        result_low_price.place(x=270,y=400)
...
#บอกข้อความ
Label1 = Label(font=('Kanit',15),text="ขนาดสินค้า A")
Label1.place(x=50,y=100)
Label2 = Label(font=('Kanit',15),text="หน่วย")
Label2.place(x=325,y=100)
Label3 = Label(font=('Kanit',15),text="ราคาสินค้า A")
Label3.place(x=400,y=100)
Label4 = Label(font=('Kanit',15),text="บาท")
Label4.place(x=680,y=100)
Label5 = Label(font=('Kanit',15),text="ขนาดสินค้า B")
Label5.place(x=50,y=160)
Label6 = Label(font=('Kanit',15),text="หน่วย")
Label6.place(x=325,y=160)
Label7 = Label(font=('Kanit',15),text="ราคาสินค้า B")
Label7.place(x=400,y=160)
Label8 = Label(font=('Kanit',15),text="บาท")
Label8.place(x=680,y=160)
Label9 = Label(font=('Kanit',20),text="เปรียบเทียบราคาสินค้า")
